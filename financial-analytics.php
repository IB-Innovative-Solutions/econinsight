...
<head>
    ...
    <title>Financial Analytics - EconInsight Consultancy | Strategic Insights</title>
            ...
            <div class="service-overview-content">
                ...
                <div class="service-stats">
                    <div class="stat">
                        ...
                        <div class="stat-label">Financial Models</div>
                    </div>
                    <div class="stat">
        ...
        <div class="container">
            ...
            <div class="service-features-grid">
                <div class="service-feature-card">
                    ...
                    <p>Advanced financial models and projections for investment decisions and strategic planning.</p>
                </div>
                <div class="service-feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Comprehensive analysis of financial performance, KPIs, and operational metrics.</p>
                </div>
                <div class="service-feature-card">
                    <div class="feature-icon">
                    ...
                    <p>ROI calculations, risk assessment, and investment opportunity evaluation.</p>
                </div>
                <div class="service-feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Strategic budget development and financial resource allocation optimization.</p>
                </div>
                <div class="service-feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Financial strategies for business expansion, scaling, and market penetration.</p>
                </div>
                <div class="service-feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Financial risk assessment and mitigation strategies for business continuity.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="case-study-content">
                <div class="case-study-text">
                    ...
                    <p class="case-study-description">
                        ...
                        resulting in a complete turnaround and sustainable profitability.
                    </p>
                    <div class="case-study-results">
                        <div class="result">
                            <div class="result-number">150%</div>
                            <div class="result-label">Profit Increase</div>
                        </div>
                        <div class="result">
                            <div class="result-number">$8M</div>
                            <div class="result-label">Cost Savings</div>
                        </div>
                        <div class="result">
                            <div class="result-number">200+</div>
                            <div class="result-label">Jobs Preserved</div>
                        </div>
                    </div>
                </div>
                <div class="case-study-image">
                    <img src="assets/img/office-scene-close-up.jpg" alt="Financial Analytics Case Study" class="case-study-img">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="process-steps">
                <div class="process-step">
                    ...
                    <p>We analyze your current financial position and identify key performance indicators.</p>
                </div>
                <div class="process-step">
                    <div class="step-number">02</div>
                    <h3>Data Analysis</h3>
                    <p>Comprehensive analysis of financial data to identify trends and opportunities.</p>
                </div>
                <div class="process-step">
                    <div class="step-number">03</div>
                    <h3>Model Development</h3>
                    <p>Creation of financial models and forecasting tools for strategic planning.</p>
                </div>
                <div class="process-step">
                    <div class="step-number">04</div>
                    <h3>Strategy Implementation</h3>
                    <p>Implementation of financial strategies and ongoing performance monitoring.</p>
                </div>
            </div>
        </div>
    </section>
